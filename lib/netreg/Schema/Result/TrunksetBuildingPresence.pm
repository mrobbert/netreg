package netreg::Schema::Result::TrunksetBuildingPresence;
...
netreg::Schema::Result::TrunksetBuildingPresence
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cqVm8VQHI1HFdWKt5UOZUA
