package netreg::Schema::Result::TrunksetMachinePresence;
...
netreg::Schema::Result::TrunksetMachinePresence
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OWErf34VeooxukEsuIK3IA
