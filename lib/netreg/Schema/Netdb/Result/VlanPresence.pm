package netreg::Schema::Netdb::Result::VlanPresence;
...
netreg::Schema::Netdb::Result::VlanPresence
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CHQETKlBuH2XWuzAJ+HOhw
