package netreg::Schema::Netdb::Result::AttributeSpec;
...
netreg::Schema::Netdb::Result::AttributeSpec
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OMv7vJxKWnefsUWY7lUreg
