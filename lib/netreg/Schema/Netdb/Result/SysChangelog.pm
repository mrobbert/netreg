package netreg::Schema::Netdb::Result::SysChangelog;
...
netreg::Schema::Netdb::Result::SysChangelog
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DpqvnlFKpluKXQZAIB1nVg
