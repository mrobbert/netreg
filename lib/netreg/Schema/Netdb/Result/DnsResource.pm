package netreg::Schema::Netdb::Result::DnsResource;
...
netreg::Schema::Netdb::Result::DnsResource
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:jgv4KzFBIoue4HqL+FBKqA
