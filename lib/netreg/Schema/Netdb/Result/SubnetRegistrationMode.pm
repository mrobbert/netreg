package netreg::Schema::Netdb::Result::SubnetRegistrationMode;
...
netreg::Schema::Netdb::Result::SubnetRegistrationMode
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XP4utqz4WFbWGAeAq1Z+wA
