package netreg::Schema::Netdb::Result::ServiceType;
...
netreg::Schema::Netdb::Result::ServiceType
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xuRazsUhGIRJ4SbezqZB8A
